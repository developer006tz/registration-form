    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.districts.index_title')</h4>
            </div>
                ...
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left">
                                @lang('crud.districts.inputs.regions_id')
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $district->name ?? '-' }}</td>
                            <td>
                                {{ optional($district->regions)->name ?? '-' }}
                            </td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="3">{!! $districts->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
