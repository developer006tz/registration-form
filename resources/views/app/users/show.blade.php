    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-4">
                ...
                <div class="mb-4">
                    <h5>@lang('crud.users.inputs.district_id')</h5>
                    <span>{{ optional($user->district)->name ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.users.inputs.regions_id')</h5>
                    <span>{{ optional($user->regions)->name ?? '-' }}</span>
                </div>
            </div>
